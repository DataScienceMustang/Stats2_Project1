...
# Gut Model - EDA first - human variable selection - Some tech use to look at optimum number of predictors
```{r}
modeltest1 <- lm(Life.expectancy ~ Income.composition.of.resources + SchoolFactor + LHIV.AIDS + Adult.Mortality + Linfant.deaths, data = train)
summary(modeltest1)
vif(modeltest1)
