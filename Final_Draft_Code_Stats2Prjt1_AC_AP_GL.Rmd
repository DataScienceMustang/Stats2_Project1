...
```{r}
corr <- Life14 %>% 
  select(Life.expectancy, LHIV.AIDS, Linfant.deaths, LUnder5Deaths, LThin19, LGDP, GDP, infant.deaths, HIV.AIDS, under.five.deaths, thinness..1.19.years) 
...
```{r}
exclude_factors <- c( "Status", "thinness..1.19.years", "under.five.deaths", "IncomeCompFactor",
...
corr <- Life14 %>% select( -all_of(exclude_factors))
